# $Id: 02_musume.t 8 2005-09-04 02:44:38Z kentaro $
...
for my $member (@members) {
    ...
    ok !$member->birthday || $member->birthday->isa('Date::Simple'),
                                          '  birthday()';
    ok $member->age,                      '  age()';
    ...
    ok !$member->graduate_date || $member->graduate_date->isa('Date::Simple'),
                                          '  birthday()';
}
